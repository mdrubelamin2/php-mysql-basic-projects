	...
	<div class="container">
		...
		<div class="row">
			<form class="col-sm-8 col-sm-offset-2" action="" method="post">
				<textarea placeholder="Paste click bait headline here" class="form-control input-lg" name="clickbait_headline" style="resize: none"></textarea><br>
		...
		<?php
			...
			if(isset($_POST["fix_submit"])){
				...
				// get first value in array returned by checkForClickBait() functions
